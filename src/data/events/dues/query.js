module.exports =  {
  eventCoutospaid: `select a.IdPrograma, a.Cuota, a.PeriodoReal, a.FechaVencimiento, a.Moneda, a.Monto
    ...
    where a.IdPrograma in (select b.IdPrograma
      ...
      where e.persona = d.IdPaciente
        ...
        and c.TipoPlan = 1
        and e.DocumentoIdentidad = @documento)
    and a.TipoCuota = 1
    and a.Situacion = 1`,
    eventCoutospending: `select a.IdPrograma, a.Cuota, a.PeriodoReal, a.FechaVencimiento, a.FechaPago, a.Moneda, a.Monto
    from SS_PG_ProgramaCuota a
    where a.IdPrograma in (select b.IdPrograma
       from SS_PG_Programa b,
            SS_PG_TipoPrograma c,
